    ...
    <div className="min-h-screen flex">
      <div className="w-1/2 bg-white flex flex-col">
        <header className="flex justify-between items-center px-8 py-6">
          ...
          <SignInButton>
            <button className="border-2 border-gray-300 rounded-lg px-5 py-2 font-semibold text-gray-600 hover:bg-gray-100 shadow-[0_4px_0_rgba(156,163,175,1)] transition-all duration-200 ease-out hover:brightness-110 hover:-translate-y-1">
              Log In
            </button>
          </SignInButton>
        </header>
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="w-full max-w-sm space-y-4 mb-28">
            ...
            <Button
              ...
              className="w-full bg-[#3a25d9] text-white font-bold py-4 shadow-[0_8px_0_#1f1a99] transition-all duration-200 ease-out hover:bg-[#2c1fbf] hover:brightness-110 hover:-translate-y-1 hover:shadow-[0_12px_0_#1f1a99]"
            >
              Sign Up
            </Button>
          </div>
